...
abstract contract L2NaffleBaseInternal is IL2NaffleBaseInternal, AccessControlInternal {
     ...
     * @params _platformDiscountParams the platform discount params.
     */
    function _setWinner(
        uint256 _naffleId,
     ...
     * @param _platformDiscountSignature the platform discount signature.
     */
    function _validatePlatformDiscountSignature(
        NaffleTypes.PlatformDiscountParams memory _platformDiscountParams,
        bytes32 _platformDiscountSignature
    ) internal view {
        ...
        bytes32 dataHash = keccak256(
            abi.encode(
                _platformDiscountSignature,
                _platformDiscountParams.platformDiscountInPercent
            )
        );
    ...
    /**
     * @notice sets the platofrmDiscountSignatureHash
     * @param _platformDiscountSignatureHash the platofrmDiscountSignatureHash.
     */
    function _setPlatformDiscountSignatureHash(bytes32 _platformDiscountSignatureHash) internal {
        L2NaffleBaseStorage.layout().platformDiscountSignatureHash = _platformDiscountSignatureHash;
    }
