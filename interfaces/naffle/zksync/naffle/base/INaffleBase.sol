...
interface INaffleBase {
    ...
    function createNaffle(address _owner, address _naffleAddress, uint256 _nftId, uint256 paidTicketSpots, uint256 _endTime, uint256 _ticketPriceInWei, NaffleTypes.NaffleType _naffleType) external;
    ...
    function getNaffleInfo(uint256 _naffleId) external returns(NaffleTypes.Naffle memory);
