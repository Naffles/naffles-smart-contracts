...
import type {
  L1NaffleBaseInternal,
  L1NaffleBaseInternalInterface,
} from "../../../../contracts/naffle/ethereum/L1NaffleBaseInternal";
...
export class L1NaffleBaseInternal__factory {
  ...
  static createInterface(): L1NaffleBaseInternalInterface {
    return new utils.Interface(_abi) as L1NaffleBaseInternalInterface;
  }
  static connect(
    address: string,
