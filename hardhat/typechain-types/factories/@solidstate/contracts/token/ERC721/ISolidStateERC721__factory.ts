...
import type {
  ISolidStateERC721,
  ISolidStateERC721Interface,
} from "../../../../../@solidstate/contracts/token/ERC721/ISolidStateERC721";
...
export class ISolidStateERC721__factory {
  static readonly abi = _abi;
  static createInterface(): ISolidStateERC721Interface {
    return new utils.Interface(_abi) as ISolidStateERC721Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ISolidStateERC721 {
    return new Contract(address, _abi, signerOrProvider) as ISolidStateERC721;
  }
}
