...
import type {
  SolidStateERC721,
  SolidStateERC721Interface,
} from "../../../../../@solidstate/contracts/token/ERC721/SolidStateERC721";
...
export class SolidStateERC721__factory {
  static readonly abi = _abi;
  static createInterface(): SolidStateERC721Interface {
    return new utils.Interface(_abi) as SolidStateERC721Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SolidStateERC721 {
    return new Contract(address, _abi, signerOrProvider) as SolidStateERC721;
  }
}
