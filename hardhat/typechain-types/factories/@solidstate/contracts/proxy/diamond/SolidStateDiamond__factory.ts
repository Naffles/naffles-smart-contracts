...
} from "../../../../../@solidstate/contracts/proxy/diamond/SolidStateDiamond";
...
export class SolidStateDiamond__factory {
  ...
  static createInterface(): SolidStateDiamondInterface {
    return new utils.Interface(_abi) as SolidStateDiamondInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SolidStateDiamond {
    return new Contract(address, _abi, signerOrProvider) as SolidStateDiamond;
  }
}
