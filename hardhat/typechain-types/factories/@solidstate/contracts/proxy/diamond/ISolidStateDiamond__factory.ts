...
} from "../../../../../@solidstate/contracts/proxy/diamond/ISolidStateDiamond";
...
export class ISolidStateDiamond__factory {
  ...
  static createInterface(): ISolidStateDiamondInterface {
    return new utils.Interface(_abi) as ISolidStateDiamondInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ISolidStateDiamond {
    return new Contract(address, _abi, signerOrProvider) as ISolidStateDiamond;
  }
}
