...
export interface VerifierInterface extends utils.Interface {
  functions: {
    ...
    "get_verification_key()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "get_verification_key",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Verifier extends BaseContract {
  ...
  functions: {
    ...
    get_verification_key(
      ...
      [VerificationKeyStructOutput] & { vk: VerificationKeyStructOutput }
    >;
  ...
  get_verification_key(
    overrides?: CallOverrides
  ): Promise<VerificationKeyStructOutput>;
  ...
  estimateGas: {
    ...
    get_verification_key(overrides?: CallOverrides): Promise<BigNumber>;
