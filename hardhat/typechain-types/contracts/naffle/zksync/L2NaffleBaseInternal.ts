...
export interface L2NaffleBaseInternalInterface extends utils.Interface {
  functions: {};
...
export interface L2NaffleBaseInternal extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L2NaffleBaseInternalInterface;
