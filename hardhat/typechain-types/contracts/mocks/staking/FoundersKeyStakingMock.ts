...
export interface FoundersKeyStakingMockInterface extends utils.Interface {
  functions: {
...
export interface FoundersKeyStakingMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FoundersKeyStakingMockInterface;
