...
export interface L2PaidTicketAdminInterface extends utils.Interface {
  functions: {
...
export interface L2PaidTicketAdmin extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L2PaidTicketAdminInterface;
