...
export interface L2PaidTicketDiamondInterface extends utils.Interface {
  functions: {
...
export interface L2PaidTicketDiamond extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L2PaidTicketDiamondInterface;
