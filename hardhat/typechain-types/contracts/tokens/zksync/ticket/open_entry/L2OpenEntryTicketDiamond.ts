...
export interface L2OpenEntryTicketDiamondInterface extends utils.Interface {
  functions: {
...
export interface L2OpenEntryTicketDiamond extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L2OpenEntryTicketDiamondInterface;
