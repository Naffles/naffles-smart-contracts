...
export interface IFoundersKeyInterface extends utils.Interface {
  functions: {
    ...
    "tokenType(uint16)": FunctionFragment;
...
export interface IFoundersKey extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IFoundersKeyInterface;
