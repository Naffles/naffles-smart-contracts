...
task("refund-and-burn-ticket", "Refund and burns the tickets for a cancelled nafflle")
  ...
  .setAction(async (taskArgs, hre) => {
    const contractFactory = await hre.ethers.getContractFactory("L2PaidTicketBase");
    ...
    const refundAndBurnTicketTransaction = await contractInstance.connect(walletL2).refundAndBurnTicket(
